...
async function default_1() {
    if (!config_1.default.coverage) {
        ...
        const gasPrice = typeof config_1.default.node.gasPrice === 'string' ? config_1.default.node.gasPrice : undefined;
        const options = Object.assign(Object.assign({}, config_1.default.node), { gasPrice, accounts: accounts_1.accountsConfig, coverage: config_1.default.coverage });
        server.send(options);
